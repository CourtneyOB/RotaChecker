...
namespace RotaChecker
{
    static class RotaBuilder
    {
        static internal Rota CreateRota()
        {
            ...
            rota.AddShift(new Shift(new DateTime(2021, 11, 20, 23, 0, 0), new DateTime(2021, 11, 21, 6, 0, 0)));
            rota.AddShift(new Shift(new DateTime(2021, 11, 23, 7, 30, 0), new DateTime(2021, 11, 22, 17, 0, 0)));
