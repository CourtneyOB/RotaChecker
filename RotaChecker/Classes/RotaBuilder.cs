...
namespace RotaChecker
{
    static class RotaBuilder
    {
        static internal Rota CreateRota()
        {
            ...
            Rota rota = new Rota();
            rota.AddShift(new Shift(new DateTime(2021, 10, 10, 23, 30, 0), new DateTime(2021, 10, 11, 9, 0, 0)));
            ...
            rota.AddShift(new Shift(new DateTime(2021, 10, 12, 4, 0, 0), new DateTime(2021, 10, 12, 17, 0, 0)));
